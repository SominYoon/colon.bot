...
async def COLON_ROLL(interaction: discord.Interaction, amount:app_.Range[int,1,200]):
    
    roll = dice(a= amount, s= 6) 
    r_str:str = ""
    sd:int = 0
    ...
    d_box=discord.Embed(title=f'[{amount}d6]', color=0xa51d2d)
